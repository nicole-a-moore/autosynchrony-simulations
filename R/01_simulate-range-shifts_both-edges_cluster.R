...
simulate_range_shifts_both_edges <- function(p,
  ...
  K = 200
  r = 1
  path = file.path(paste0("outputs/data-processed/simulations_both-edges/p", params$p, "_b", params$beta, "_icp", params$icp, "_K", params$K, "_d", 
  ...
  while(t <= L) {
    ...
    if(t == 1) {
      ...
      filename =  paste0("output/env-grids/range-shift-grid_both-edges_rep", rep, "_p", p, "_b", beta, "_icp", icp, "_K", K, "_d", 
