...
missing = c("Perisoreus_canadensis", "Petrochelidon_fulva", "Petrochelidon_pyrrhonota",  "Peucaea_aestivalis",
            "Peucaea_botterii", "Peucaea_carpalis",    "Peucaea_cassinii", "Peucedramus_taeniatus", "Phainopepla_nitens", 
            "Phalaenoptilus_nuttallii",  "Pheucticus_ludovicianus",   "Pheucticus_melanocephalus", "Pica_nuttalli",    
            "Picoides_arcticus",   "Picoides_dorsalis",   "Pinicola_enucleator", "Pipilo_chlorurus",  
            "Pipilo_erythrophthalmus", "Pipilo_maculatus")
species = species[which(species %in% missing )]
occ_files = paste0("occ-data/", missing, "_distinct.csv")
